...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@supabase/supabase-js/dist/index.mjs [app-ssr] (ecmascript) <locals>"); // Import Supabase
...
function BrandingPage() {
    ...
    const handleFileSelect = async (e)=>{
        ...
        // 1. Validera format
        // Tillåtna format: jpg, jpeg, png (ofta bra att ha), svg, heic
        // Notera: HEIC stöd i webbläsare är begränsat, men vi tillåter uppladdning.
        const allowedTypes = [
            'image/jpeg',
            'image/jpg',
            'image/svg+xml',
        ...
        // Extra check på filändelse ifall mime-type saknas/är konstig
        const allowedExts = [
            'jpg',
            'jpeg',
            'svg',
        ...
        if (!isValidType && !isValidExt) {
            setErrorMsg("Filformatet känns inte igen. Vi rekommenderar JPG, JPEG, SVG eller HEIC för att din logga ska se bäst ut i alla enheter.");
            return;
        }
        // 2. Ladda upp till Supabase Storage
        setIsUploading(true);
        try {
            // Skapa ett unikt filnamn: userId/timestamp.ext
            const fileName = `${userId}/${Date.now()}.${fileExt || 'jpg'}`;
            const { data: uploadData, error: uploadError } = await supabase.storage.from('company_logos').upload(fileName, file, {
                cacheControl: '3600',
                upsert: true
            });
            ...
            setErrorMsg("Kunde inte ladda upp bilden. Försök igen eller välj en annan bild.");
        } finally{
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: [
                                                            "Vi stödjer JPG, JPEG, SVG och HEIC.",
...
//# sourceMappingURL=_3ff868ab._.js.map