module.exports = [
"[project]/node_modules/@mendable/firecrawl-js/dist/chunk-GY35KXDS.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mendable$2f$firecrawl$2d$js$2f$dist$2f$chunk$2d$GY35KXDS$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mendable/firecrawl-js/dist/chunk-GY35KXDS.js [app-route] (ecmascript)");
...
function getVersion() {
    try {
        ...
        const pkg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mendable$2f$firecrawl$2d$js$2f$dist$2f$chunk$2d$GY35KXDS$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["require_package"])();
...
var HttpClient = class {
    ...
    constructor(options){
        ...
        this.instance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            baseURL: this.apiUrl,
...
function ensureValidFormats(formats) {
    ...
    for (const fmt of formats){
        ...
        if (fmt.type === "json") {
            ...
            if (isZod) {
                try {
                    j.schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2d$to$2d$json$2d$schema$2f$dist$2f$esm$2f$zodToJsonSchema$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["zodToJsonSchema"])(maybeSchema);
                } catch  {}
            }
            continue;
        }
        if (fmt.type === "changeTracking") {
            ...
            if (isZod) {
                try {
                    ct.schema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2d$to$2d$json$2d$schema$2f$dist$2f$esm$2f$zodToJsonSchema$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["zodToJsonSchema"])(maybeSchema);
                } catch  {}
            }
            continue;
        }
...
async function map(http, url, options) {
    ...
    try {
        ...
        for (const item of linksIn){
            if (typeof item === "string") links.push({
                url: item
            });
        ...
        try {
            ...
            if (!isRetryableError(err)) {
                if (err instanceof SdkError) {
                    const errorWithJobId = new SdkError(err.message, err.status, err.code, err.details, jobId);
...
async function startBatchScrape(http, urls, { options, webhook, appendToId, ignoreInvalidURLs, maxConcurrency, zeroDataRetention, idempotencyKey, integration } = {}) {
...
function prepareExtractPayload(args) {
    ...
    if (args.schema != null) {
        ...
        body.schema = isZod ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2d$to$2d$json$2d$schema$2f$dist$2f$esm$2f$zodToJsonSchema$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["zodToJsonSchema"])(s) : args.schema;
    }
...
var loadNodeWebSocket = async ()=>{
    ...
    try {
        const undici = await (()=>{
            const e = new Error("Cannot find module 'undici'");
...
var Watcher = class extends __TURBOPACK__imported__module__$5b$externals$5d2f$events__$5b$external$5d$__$28$events$2c$__cjs$29$__["EventEmitter"] {
    http;
    jobId;
    kind;
    pollInterval;
...
var FirecrawlClient = class {
   ...
   */ async cancelAgent(jobId) {
    ...
    // Usage
    /** Current concurrency usage. */ async getConcurrency() {
        return getConcurrency(this.http);
    }
    /** Current credit usage. */ async getCreditUsage() {
        return getCreditUsage(this.http);
    }
    /** Recent token usage. */ async getTokenUsage() {
        return getTokenUsage(this.http);
    }
    /** Historical credit usage by month; set byApiKey to true to break down by API key. */ async getCreditUsageHistorical(byApiKey) {
        return getCreditUsageHistorical(this.http, byApiKey);
    }
    /** Historical token usage by month; set byApiKey to true to break down by API key. */ async getTokenUsageHistorical(byApiKey) {
        return getTokenUsageHistorical(this.http, byApiKey);
    }
    /** Metrics about the team's scrape queue. */ async getQueueStatus() {
...
var FirecrawlApp = class {
    ...
    async getVersion() {
        try {
            ...
            const packageJson = await __turbopack_context__.A("[project]/node_modules/@mendable/firecrawl-js/dist/package-THA2MQX4.js [app-route] (ecmascript, async loader)");
   ...
   */ isRetryableError(error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosError"]) {
            if (!error.response) {
   ...
   */ handleError(response, action) {
        if (!response) {
            throw new FirecrawlError(`No response received while trying to ${action}. This may be a network error or the server is unreachable.`, 0);
        }
        if ([
            400,
            402,
...
var Firecrawl = class extends FirecrawlClient {
    /** Feature‑frozen v1 client (lazy). */ _v1;
    _v1Opts;
    /** @param opts API credentials and base URL. */ constructor(opts = {}){
        super(opts);
        this._v1Opts = {
            apiKey: opts.apiKey,
            apiUrl: opts.apiUrl
    ...
    /** Access the legacy v1 client (instantiated on first access). */ get v1() {
...
//# sourceMappingURL=node_modules_%40mendable_firecrawl-js_dist_13108b19._.js.map